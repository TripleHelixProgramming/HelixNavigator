...
// /**
//  * This class represents the "Undo" menu item in the edit menu.
//  * 
...
//     /**
//      * Constructs a <code>UndoMenuItem</code> and sets its text, graphic, and action.
//      */
//     public UndoMenuItem() {
//         setText("Undo");
//         setAccelerator(KeyCombination.keyCombination("shortcut+Z"));
        
//         graphic = new Image(getClass().getResourceAsStream("/icons/edit/undo.png"));
