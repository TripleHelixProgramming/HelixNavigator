...
// /**
//  * This class represents the "Copy" menu item in the edit menu.
//  * 
...
//     /**
//      * Constructs a <code>CopyMenuItem</code> and sets its text, graphic, and action.
//      */
//     public CopyMenuItem() {
//         setText("Copy");
//         setAccelerator(KeyCombination.keyCombination("shortcut+C"));
        
//         graphic = new Image(getClass().getResourceAsStream("/icons/edit/copy.png"));
