...
/**
 * This class represents the "Redo" menu item in the edit menu.
 * 
...
public class RedoMenuItem extends MenuItem {
    ...
    /**
     * Constructs a <code>RedoMenuItem</code> and sets its text, graphic, and action.
     */
    public RedoMenuItem() {
        setText("Redo");
        setAccelerator(KeyCombination.keyCombination("shortcut+Y"));
        
        graphic = new Image(getClass().getResourceAsStream("/icons/edit/redo.png"));
